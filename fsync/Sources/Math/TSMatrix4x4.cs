...
namespace fsync.amath
{
	...
	public class TSMatrix4x4
	{
		...
		public TSMatrix4x4()
		{
			...
			this.M14 = MyMath.Zero;
			this.M21 = MyMath.Zero;
			this.M22 = MyMath.One;
			this.M23 = MyMath.Zero;
			this.M24 = MyMath.Zero;
			this.M31 = MyMath.Zero;
			this.M32 = MyMath.Zero;
			this.M33 = MyMath.One;
			this.M34 = MyMath.Zero;
			this.M41 = MyMath.Zero;
			this.M42 = MyMath.Zero;
			this.M43 = MyMath.Zero;
			this.M44 = MyMath.One;
		}
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Multiply_2(ref matrix1, ref matrix2, result);
			return result;
		}
		...
		private static void Multiply_2(ref TSMatrix4x4 matrix1, ref TSMatrix4x4 matrix2, TSMatrix4x4 result)
		{
			// First row
		...
		/// <param name="matrix2">The second matrix.</param>
		/// <param name="result">The product of both matrices.</param>
		public static void Multiply(ref TSMatrix4x4 matrix1, ref TSMatrix4x4 matrix2, TSMatrix4x4 result)
		{
			// First row
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Add(ref matrix1, ref matrix2, result);
			return result;
		}
		...
		public static void Add(ref TSMatrix4x4 matrix1, ref TSMatrix4x4 matrix2, TSMatrix4x4 result)
		{
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Inverse(ref matrix, result);
			return result;
		}
		...
		public static void Inverse(ref TSMatrix4x4 matrix, TSMatrix4x4 result)
		{
			//                                       -1
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Multiply(ref matrix1, scaleFactor, result);
			return result;
		}
		...
		public static void Multiply(ref TSMatrix4x4 matrix1, FP scaleFactor, TSMatrix4x4 result)
		{
			FP num = scaleFactor;
		...
		public static TSMatrix4x4 Rotate(Quaternion quaternion)
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Rotate(ref quaternion, result);
			return result;
		}
		...
		public static void Rotate(ref Quaternion quaternion, TSMatrix4x4 result)
		{
			...
			result.M11 = MyMath.One - (yy + zz);
			result.M21 = xy + wz;
			result.M31 = xz - wy;
			result.M41 = MyMath.Zero;
			result.M12 = xy - wz;
			result.M22 = MyMath.One - (xx + zz);
			result.M32 = yz + wx;
			result.M42 = MyMath.Zero;
			result.M13 = xz + wy;
			result.M23 = yz - wx;
			result.M33 = MyMath.One - (xx + yy);
			result.M43 = MyMath.Zero;
			result.M14 = MyMath.Zero;
			result.M24 = MyMath.Zero;
			result.M34 = MyMath.Zero;
			result.M44 = MyMath.One;
		}
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Transpose(ref matrix, result);
			return result;
		}
		...
		public static void Transpose(ref TSMatrix4x4 matrix, TSMatrix4x4 result)
		{
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Multiply(ref value1, ref value2, result);
			return result;
		}
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Add(ref value1, ref value2, result);
			return result;
		}
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TSMatrix4x4.Multiply(ref value2, -MyMath.One, value2);
			TSMatrix4x4.Add(ref value1, ref value2, result);
			return result;
		}
		...
		public static TSMatrix4x4 Translate(FP xPosition, FP yPosition, FP zPosition)
		{
			...
			result.M11 = MyMath.One; result.M12 = MyMath.Zero; result.M13 = MyMath.Zero; result.M14 = xPosition;
			result.M21 = MyMath.Zero; result.M22 = MyMath.One; result.M23 = MyMath.Zero; result.M24 = yPosition;
			result.M31 = MyMath.Zero; result.M32 = MyMath.Zero; result.M33 = MyMath.One; result.M34 = zPosition;
			result.M41 = MyMath.Zero; result.M42 = MyMath.Zero; result.M43 = MyMath.Zero; result.M44 = MyMath.One;
		...
		public static TSMatrix4x4 Scale(FP xScale, FP yScale, FP zScale)
		{
			...
			result.M11 = xScale; result.M12 = MyMath.Zero; result.M13 = MyMath.Zero; result.M14 = MyMath.Zero;
			result.M21 = MyMath.Zero; result.M22 = yScale; result.M23 = MyMath.Zero; result.M24 = MyMath.Zero;
			result.M31 = MyMath.Zero; result.M32 = MyMath.Zero; result.M33 = zScale; result.M34 = MyMath.Zero;
			result.M41 = MyMath.Zero; result.M42 = MyMath.Zero; result.M43 = MyMath.Zero; result.M44 = MyMath.One;
		...
		public static TSMatrix4x4 Scale(FP xScale, FP yScale, FP zScale, TSVector centerPoint)
		{
			...
			FP tx = centerPoint.x * (MyMath.One - xScale);
			FP ty = centerPoint.y * (MyMath.One - yScale);
			FP tz = centerPoint.z * (MyMath.One - zScale);

			result.M11 = xScale; result.M12 = MyMath.Zero; result.M13 = MyMath.Zero; result.M14 = MyMath.Zero;
			result.M21 = MyMath.Zero; result.M22 = yScale; result.M23 = MyMath.Zero; result.M24 = MyMath.Zero;
			result.M31 = MyMath.Zero; result.M32 = MyMath.Zero; result.M33 = zScale; result.M34 = MyMath.Zero;
			result.M41 = tx; result.M42 = ty; result.M43 = tz; result.M44 = MyMath.One;
		...
		public static TSMatrix4x4 RotateX(FP radians)
		{
			...
			FP c = Math.Cos(radians);
			FP s = Math.Sin(radians);
		...
		public static TSMatrix4x4 RotateX(FP radians, TSVector centerPoint)
		{
			...
			FP y = centerPoint.y * (MyMath.One - c) + centerPoint.z * s;
			FP z = centerPoint.z * (MyMath.One - c) - centerPoint.y * s;
		...
		public static TSMatrix4x4 RotateY(FP radians, TSVector centerPoint)
		{
			...
			FP x = centerPoint.x * (MyMath.One - c) - centerPoint.z * s;
			FP z = centerPoint.x * (MyMath.One - c) + centerPoint.x * s;
		...
		public static void AxisAngle(ref TSVector axis, FP angle, TSMatrix4x4 result)
		{
			// a: angle
			...
			FP sa = Math.Sin(angle), ca = Math.Cos(angle);
			FP xx = x * x, yy = y * y, zz = z * z;
			FP xy = x * y, xz = x * z, yz = y * z;

			result.M11 = xx + ca * (MyMath.One - xx);
			result.M12 = xy - ca * xy + sa * z;
			result.M13 = xz - ca * xz - sa * y;
			result.M14 = MyMath.Zero;
			result.M21 = xy - ca * xy - sa * z;
			result.M22 = yy + ca * (MyMath.One - yy);
			result.M23 = yz - ca * yz + sa * x;
			result.M24 = MyMath.Zero;
			result.M31 = xz - ca * xz + sa * y;
			result.M32 = yz - ca * yz - sa * x;
			result.M33 = zz + ca * (MyMath.One - zz);
			result.M34 = MyMath.Zero;
			result.M41 = MyMath.Zero;
			result.M42 = MyMath.Zero;
			result.M43 = MyMath.Zero;
		...
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			AxisAngle(ref axis, angle, result);
			return result;
		}
		...
		public static void TRS(TSVector translation, Quaternion rotation, TSVector scale, TSMatrix4x4 matrix)
		{
			matrix = TSMatrix4x4.Translate(translation) * TSMatrix4x4.Rotate(rotation) * TSMatrix4x4.Scale(scale);
		}

		public static TSMatrix4x4 TRS(TSVector translation, Quaternion rotation, TSVector scale)
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TRS(translation, rotation, scale, result);
			return result;
		}

		public static void TransformToMatrix(ref Transform transform, TSMatrix4x4 result)
		{
			TRS(transform.LocalPosition, transform.LocalRotation, transform.LocalScale, result);
		}

		public static TSMatrix4x4 TransformToMatrix(ref Transform transform)
		{
			TSMatrix4x4 result = new TSMatrix4x4();
			TRS(transform.LocalPosition, transform.LocalRotation, transform.LocalScale, result);
			return result;
